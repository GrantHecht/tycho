...
def Animate(Traj):
    ...
    ax0 = plt.subplot(
        321, xlim=(-0.05, max(T[4]) * 1.05), ylim=(min(T[0]) * 1.2, max(T[0]) * 1.1)
    )
    ax1 = plt.subplot(
        323, xlim=(-0.05, max(T[4]) * 1.05), ylim=(min(T[1]) * 1.2, max(T[1]) * 1.1)
    )
    ax2 = plt.subplot(
        325, xlim=(-0.05, max(T[4]) * 1.05), ylim=(min(T[5]) * 1.2, max(T[5]) * 1.1)
    )
    ax3 = fig.add_subplot(122, aspect="equal", xlim=(-0.4, 1.6), ylim=(-1.0, 1.0))
