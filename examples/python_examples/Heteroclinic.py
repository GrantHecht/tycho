...
def GetManifold(ode, OrbitIn, dx, dt, nman=50, Stable=True):
    ...
    for Result in Results:
        ...
        if (
            len(eventlocs[0]) == 1
            and len(eventlocs[1]) == 0
            and eventlocs[0][0] is not None
        ):
            Traj.pop()
...
if __name__ == "__main__":
    ...
    L1OrbitIG = ode.GenL1Lissajous(0.03, 0, 180, 0, 1, 100)
    L2OrbitIG = ode.GenL2Lissajous(0.03, 0, 0, 0, 1, 100)
