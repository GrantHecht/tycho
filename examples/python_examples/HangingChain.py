...
def Job(a, b, n, L):
    ...
    # A batched Jet run only auto-silences an engine still at the class
    # default print_level (0); an explicit non-default value here is
    # honored and would flood the console across 100 jobs. Use a silent
    # level explicitly.
    ipm.print_level = 3
