...
def Form1():
    ...
    phase.add_lu_var_bounds("Path", [21, 22, 23], -MaxThrust, MaxThrust)
    phase.add_lu_var_bounds("Path", [24, 25, 26], -MaxTorque, MaxTorque)
...
def Form2():
    ...
    phase.add_lu_var_bounds("Path", [14, 15, 16], -MaxThrust, MaxThrust)
    phase.add_lu_var_bounds("Path", [17, 18, 19], -MaxTorque, MaxTorque)
    phase.add_lower_norm_bound("Path", [0, 1, 2], 2 * Srad, 1.0)
