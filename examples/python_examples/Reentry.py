...
def Plot(Traj1, Traj2):
    ...
    axs[0].plot(
        TT1[5] * Tstar / 60.0, TT1[0] * Lstar / 5280, label="No Q limit", color="r"
    )
    axs[0].plot(
        TT2[5] * Tstar / 60.0, TT2[0] * Lstar / 5280, label="Q limited", color="b"
    )
    ...
    axs[2].plot(
        TT1[5] * Tstar / 60.0,
        np.rad2deg(TT1[6]),
        label="Angle of Attack No Q limit",
        color="r",
    )
    axs[2].plot(
        TT1[5] * Tstar / 60.0,
    ...
    axs[2].plot(
        TT2[5] * Tstar / 60.0,
        np.rad2deg(TT2[6]),
        label="Angle of Attack  Q limited",
        color="b",
    )
    axs[2].plot(
        TT2[5] * Tstar / 60.0,
