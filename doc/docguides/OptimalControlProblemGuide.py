...
ocp.addDirectLinkEqualCon(
    OrthoCon(), phase2, "Back", [3, 4, 5], phase3, "Front", [3, 4, 5]
)
"""
...
ocp.addLinkEqualCon(
    OrthoCon(), phase_regs, phases_to_link, xtuvars, opvars, spvars, lpvars
)
...
def ContCon():
    ...
    f = vf.stack([p4x6 - p5x6, p4o0 - p5o0, p4s0 - p5s0])
...
ocp.addLinkEqualCon(
    ContCon(), phase_regs, phases_to_link, xtuvars, opvars, spvars, lpvars
)
