...
struct Integrator : VectorFunction<Integrator<DODE>, SZ_SUM<DODE::IRC, 1>::value, DODE::IRC> {
  ...
  public:
    ...
    static void Build(py::module &m, const char *name) {
        ...
        if constexpr (DODE::UV != 0) {
            obj.def(py::init<const DODE &, std::string, double, const ControllerType &,
                             const ControlIndexType &>());
            obj.def(
                py::init<const DODE &, double, const ControllerType &, const ControlIndexType &>());
        ...
        obj.def("integrate_stm2",
                ...
                py::arg("Xt0UPs"), py::arg("tfs"), py::arg("Lfs"),
        ...
        obj.def("integrate_parallel",
                ...
                py::arg("Xt0UPs"), py::arg("tfs"), py::arg("threads"),
                py::call_guard<py::gil_scoped_release>());
        ...
        obj.def("integrate_parallel",
                ...
                py::arg("Xt0UPs"), py::arg("tfs"), py::arg("Events"), py::arg("threads"),
                py::call_guard<py::gil_scoped_release>());
        ...
        obj.def(
            "integrate_dense",
            (DenseRet (Integrator::*)(const ODEState<double> &, double, int,
        ...
        obj.def("setStepSizes", &Integrator::setStepSizes, py::arg("DefStepSize"),
                py::arg("MinStepSize"), py::arg("MaxStepSize"));
