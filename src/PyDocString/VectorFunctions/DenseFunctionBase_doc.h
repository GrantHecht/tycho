...
const char *const DFB_IRows = "Get the input size of this function\n\n"
                              ":returns: int: Number of rows for input vector";

const char *const DFB_ORows = "Get the output size of this function\n\n"
                              ":returns: int: Number of rows for output vector";

const char *const DFB_name = "Returns a string of the C++ type name.\n\n"
                             ":returns: C++ type name";

const char *const DFB_compute = "'Compute' the output of the function for the given input\n\n"
