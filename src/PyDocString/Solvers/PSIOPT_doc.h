...
const char *const PSIOPT_ObjScale = "double: Scaling factor for the objective function";
...
const char *const PSIOPT_OptBarMode = "BarrierModes: Barrier mode used when 'optimize' is called.";

const char *const PSIOPT_SoeBarMode = "BarrierModes: Barrier mode used when 'solve' is called";
...
const char *const PSIOPT_QPThreads = "int: Number of CPU threads for Pardiso. Default = 8.";
...
const char *const PSIOPT_storespmat = "bool: Whether or not to store the SP Matrix.";
