...
const char *const IntegratorBase_integrate = "Integrates state variables from t0->tf\n\n"
                                             ":param arg0: Vector of state variables to integrate\n"
...
const char *const IntegratorBase_DefStepSize = "Step size of constant step integration\n\n"
                                               ":type : double\n";

const char *const IntegratorBase_MaxStepSize = "Maximum step length for adaptive integration\n\n"
                                               ":type : double\n";

const char *const IntegratorBase_MinStepSize = "Minimum step length for adaptive integration\n\n"
                                               ":type : double\n";
const char *const IntegratorBase_MaxStepChange =
    "Maximum allowable step size change between steps of adaptive integration\n\n"
    ":type : double\n";

const char *const IntegratorBase_Adaptive = "Set adaptive integration\n\n"
                                            ":type : bool\n";

const char *const IntegratorBase_AbsTols = "Absolute tolerance for adaptive integration\n\n"
                                           ":type : double\n";
...
const char *const IntegratorBase_get_stepper = "Returns stepper for Integrator object\n\n"
