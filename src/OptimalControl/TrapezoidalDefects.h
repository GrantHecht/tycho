...
struct TrapezoidalDefects
    ...
    inline void compute_impl(const Eigen::MatrixBase<InType> &x,
        ...
        MemoryManager::allocate_run(irows, Impl, TempSpec<IType>(irows, 1),
                                    TempSpec<IType>(irows, 1), TempSpec<OType>(orows, 1),
    ...
    inline void compute_jacobian_impl(const Eigen::MatrixBase<InType> &x,
        ...
        MemoryManager::allocate_run(irows, Impl, TempSpec<IType>(irows, 1),
                                    TempSpec<IType>(irows, 1), TempSpec<OType>(orows, 1),
                                    TempSpec<OType>(orows, 1), TempSpec<JType>(orows, irows),
