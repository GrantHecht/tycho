...
static void InterpTable1DBuild(py::module &m) {
    ...
    obj.def(py::init<const Eigen::VectorXd &, const Eigen::VectorXd &, int, std::string>(),
            py::arg("ts"), py::arg("Vs"), py::arg("axis") = 0,
            py::arg("kind") = std::string("cubic"));

    obj.def(py::init<const Eigen::VectorXd &, const MatType &, int, std::string>(), py::arg("ts"),
            py::arg("Vs"), py::arg("axis") = 0, py::arg("kind") = std::string("cubic"));

    obj.def(py::init<const std::vector<Eigen::VectorXd> &, int, std::string>(), py::arg("Vts"),
            py::arg("tvar") = -1, py::arg("kind") = std::string("cubic"));
    ...
    obj.def("__call__", py::overload_cast<double>(&InterpTable1D::interp, py::const_),
            py::is_operator());
    obj.def("__call__",
            py::overload_cast<const Eigen::VectorXd &>(&InterpTable1D::interp, py::const_),
            py::is_operator());
