...
static void InterpTable2DBuild(py::module &m) {
    ...
    obj.def(py::init<const Eigen::VectorXd &, const Eigen::VectorXd &,
    ...
    obj.def("interp", py::overload_cast<const MatType &, const MatType &>(&InterpTable2D::interp,
                                                                          py::const_));
    ...
    obj.def("__call__", py::overload_cast<double, double>(&InterpTable2D::interp, py::const_),
            py::is_operator());
    obj.def("__call__",
