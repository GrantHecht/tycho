...
template <int IR, int OR> struct DenseFunctionSpec {
    ...
    template <class Holder> struct Model : public Holder, public virtual Concept {
        ...
        virtual void right_jacobian_product(ConstMatrixBaseRef<RightJacTarget> target_,
            ...
            return rubber_types::model_get(this).right_jacobian_product(target_, left, right,
                                                                        assign, aliased);
        }
        virtual void right_jacobian_product(ConstMatrixBaseRef<RightJacTarget> target_,
                                            ConstEigenBaseRef<LeftJacMatrix> left,
    ...
    template <class Container> struct ExternalInterface : public Container {
        ...
        */
        ...
        bool is_linear() const { return rubber_types::interface_get(this).is_linear(); }
        ...
        void compute_jacobian(ConstVectorBaseRef<InTypeTT> x, ConstVectorBaseRef<OutTypeTT> fx_,
        ...
        void compute_jacobian_adjointgradient_adjointhessian(
            ...
            if constexpr (std::is_same<Scalar, double>::value) {
                ...
                return rubber_types::interface_get(this)
                    .compute_jacobian_adjointgradient_adjointhessian(xt, fxt, jxt, adjgradt,
                                                                     adjhesst, adjvarst);
            } else {
                SuperInType xt(x.derived());
                SuperOutType fxt(fx_.const_cast_derived());
        ...
        void right_jacobian_product(ConstMatrixBaseRef<TargetTT> target_,
                                    ...
                                    ConstMatrixBaseRef<RightTT> right, Assignment assign,
            ...
            return rubber_types::interface_get(this).right_jacobian_product(target, leftt, rightt,
                                                                            assign, aliased);
        }
