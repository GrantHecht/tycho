...
//
// Defines the rubber_types compatible type erasure spec SizableSpec
...
struct SizableSpec {
    ...
    template <class Holder> struct Model : public Holder, public virtual Concept {
        ...
        virtual int ORows() const override { return rubber_types::model_get(*this).ORows(); }
    ...
    template <class Container> struct ExternalInterface : public Container {
        ...
        bool thread_safe() const { return rubber_types::interface_get(*this).thread_safe(); }
    };
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
};
