...
struct DenseFunctionBase : Computable<Derived, IR, OR>, DomainHolder<IR> {
  ...
  public:
    template <class PYClass> static void DenseBaseBuild(PYClass &obj) {
        ...
        obj.def("adjointgradient", [](const Derived &func, ConstEigenRef<Input<double>> x,
        ...
        obj.def("adjointhessian", [](const Derived &func, ConstEigenRef<Input<double>> x,
                                     ConstEigenRef<Output<double>> lm) {
            if (x.size() != func.IRows())
                throw std::invalid_argument("Incorrectly sized input to function");
            if (lm.size() != func.ORows())
        ...
        obj.def("computeall", [](const Derived &func, ConstEigenRef<Input<double>> x,
                                 ConstEigenRef<Output<double>> lm) {
            if (x.size() != func.IRows())
                throw std::invalid_argument("Incorrectly sized input to function");
            if (lm.size() != func.ORows())
