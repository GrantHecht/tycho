...
Eigen::VectorXd ASSET::PSIOPT::init_impl(const Eigen::VectorXd &x, double Mu, bool docompute) {
    ...
    this->evalNLP(AlgorithmModes::INIT, this->ObjScale, XSL, val, RHS.head(this->PrimalVars), RHS,
...
double ASSET::PSIOPT::ls_impl(LineSearchModes lsmode, double ObjScale, double Mu, double PrimObj,
    ...
    if (lsmode == LineSearchModes::LANG) {
        ...
        for (int j = 0; j < this->MaxLSIters; j++) {
            ...
            XSL2 = XSL + alpha * DXSL;
            RHS2.setZero();
            this->nlp->evalOCC(ObjScale, XSL2.head(this->PrimalVars), ptest,
...
void ASSET::PSIOPT::Build(py::module &m) {
    ...
    obj.def("set_tols", &PSIOPT::set_tols, py::arg("KKTtol") = 1.0e-6, py::arg("EContol") = 1.0e-6,
            py::arg("IContol") = 1.0e-6, py::arg("Bartol") = 1.0e-6);
    ...
    obj.def("set_Acctols", &PSIOPT::set_Acctols, py::arg("AccKKTtol") = 1.0e-2,
            py::arg("AccEContol") = 1.0e-3, py::arg("AccIContol") = 1.0e-3,
    ...
    obj.def("set_HpertParams", &PSIOPT::set_HpertParams, py::arg("deltaH"), py::arg("incrH"),
            py::arg("decrH"));
    ...
    obj.def("set_QPOrderingMode",
            py::overload_cast<const std::string &>(&PSIOPT::set_QPOrderingMode));
