...
void Tycho::OptimalControlProblem::Build(py::module &m) {
    ...
    obj.def("addPhase", py::overload_cast<PhasePtr>(&OptimalControlProblem::addPhase),
    ...
    obj.def("setLinkParams",
            py::overload_cast<VectorXd, VectorXd>(&OptimalControlProblem::setLinkParams));
    obj.def("setLinkParams", py::overload_cast<VectorXd>(&OptimalControlProblem::setLinkParams),
            OptimalControlProblem_setLinkParams);

    obj.def("addLinkParamVgroups", py::overload_cast<std::map<std::string, Eigen::VectorXi>>(
                                       &OptimalControlProblem::addLinkParamVgroups));
    obj.def("setLinkParamVgroups", py::overload_cast<std::map<std::string, Eigen::VectorXi>>(
                                       &OptimalControlProblem::setLinkParamVgroups));
    obj.def("addLinkParamVgroup", py::overload_cast<Eigen::VectorXi, std::string>(
    ...
    obj.def("transcribe", py::overload_cast<bool, bool>(&OptimalControlProblem::transcribe),
    ...
    obj.def("setAdaptiveMesh", &OptimalControlProblem::setAdaptiveMesh,
            py::arg("AdaptiveMesh") = true, py::arg("ApplyToPhases") = true);
    obj.def("setAutoScaling", &OptimalControlProblem::setAutoScaling, py::arg("AutoScaling") = true,
...
void Tycho::OptimalControlProblem::BuildNewLinkIterface(
    ...
    //////////// EqualCons////////////////////////////////////////
    {
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, std::vector<PhasePack>, VarIndexType, ScaleType>(
                &OptimalControlProblem::addLinkEqualCon),
            py::arg("func"), py::arg("phasepack"), py::arg("linkparams") = VectorXi(),
            py::arg("AutoScale") = std::string("auto"));

        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, PhaseRefType, RegionType, VarIndexType,
                              VarIndexType, VarIndexType, PhaseRefType, RegionType, VarIndexType,
                              VarIndexType, VarIndexType, VarIndexType, ScaleType>(
                &OptimalControlProblem::addLinkEqualCon),
            py::arg("func"), py::arg("phase0"), py::arg("reg0"), py::arg("XtUVars0"),
            py::arg("OPVars0"), py::arg("SPVars0"), py::arg("phase1"), py::arg("reg1"),
            py::arg("XtUVars1"), py::arg("OPVars1"), py::arg("SPVars1"),
            py::arg("linkparams") = VectorXi(), py::arg("AutoScale") = std::string("auto"));

        obj.def("addLinkEqualCon",
                py::overload_cast<VectorFunctionalX, PhaseRefType, RegionType, VarIndexType,
                                  PhaseRefType, RegionType, VarIndexType, VarIndexType, ScaleType>(
                    &OptimalControlProblem::addLinkEqualCon),
                py::arg("func"), py::arg("phase0"), py::arg("reg0"), py::arg("v0"),
                py::arg("phase1"), py::arg("reg1"), py::arg("v1"),
                py::arg("linkparams") = VectorXi(), py::arg("AutoScale") = std::string("auto"));

        obj.def("addLinkParamEqualCon",
                py::overload_cast<VectorFunctionalX, std::vector<VectorXi>, ScaleType>(
                    &OptimalControlProblem::addLinkParamEqualCon),
                py::arg("func"), py::arg("LinkParms"), py::arg("AutoScale") = std::string("auto"));
        obj.def("addLinkParamEqualCon",
                py::overload_cast<VectorFunctionalX, VectorXi, ScaleType>(
                    &OptimalControlProblem::addLinkParamEqualCon),
                py::arg("func"), py::arg("LinkParms"), py::arg("AutoScale") = std::string("auto"));

        obj.def("addForwardLinkEqualCon",
                py::overload_cast<PhaseRefType, PhaseRefType, VarIndexType, ScaleType>(
                    &OptimalControlProblem::addForwardLinkEqualCon),
                py::arg("phase0"), py::arg("phase1"), py::arg("vars"),
                py::arg("AutoScale") = std::string("auto"));

        obj.def("addParamLinkEqualCon",
                py::overload_cast<PhaseRefType, PhaseRefType, RegionType, VarIndexType, ScaleType>(
                    &OptimalControlProblem::addParamLinkEqualCon),
                py::arg("phase0"), py::arg("phase1"), py::arg("reg0"), py::arg("vars"),
                py::arg("AutoScale") = std::string("auto"));

        obj.def("addDirectLinkEqualCon",
                py::overload_cast<PhaseRefType, RegionType, VarIndexType, PhaseRefType, RegionType,
                                  VarIndexType, ScaleType>(
                    &OptimalControlProblem::addDirectLinkEqualCon),
                py::arg("phase0"), py::arg("reg0"), py::arg("v0"), py::arg("phase1"),
                py::arg("reg1"), py::arg("v1"), py::arg("AutoScale") = std::string("auto"));
    }
    ...
    //////////// Objectives ////////////////////////////////////////
    {
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, std::vector<PhasePack>, VarIndexType, ScaleType>(
        ...
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, PhaseRefType, RegionType, VarIndexType,
                              VarIndexType, VarIndexType, PhaseRefType, RegionType, VarIndexType,
                              VarIndexType, VarIndexType, VarIndexType, ScaleType>(
                &OptimalControlProblem::addLinkObjective),
            py::arg("func"), py::arg("phase0"), py::arg("reg0"), py::arg("XtUVars0"),
        ...
        obj.def("addLinkParamObjective",
                py::overload_cast<ScalarFunctionalX, std::vector<VectorXi>, ScaleType>(
                    &OptimalControlProblem::addLinkParamObjective),
                py::arg("func"), py::arg("LinkParms"), py::arg("AutoScale") = std::string("auto"));
        obj.def("addLinkParamObjective",
                py::overload_cast<ScalarFunctionalX, VectorXi, ScaleType>(
                    &OptimalControlProblem::addLinkParamObjective),
                py::arg("func"), py::arg("LinkParms"), py::arg("AutoScale") = std::string("auto"));
    }
}
...
void Tycho::OptimalControlProblem::BuildOldLinkIterface(
...

    {
        ...
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, std::vector<std::string>, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkEqualCon));

        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, LinkFlags, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkEqualCon));
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, std::string, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkEqualCon));
        ...
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, std::vector<std::string>,
        ...
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, LinkFlags, std::vector<std::vector<PhasePtr>>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkEqualCon));
        obj.def(
            "addLinkEqualCon",
            py::overload_cast<VectorFunctionalX, std::string, std::vector<std::vector<PhasePtr>>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkEqualCon));
        ...
        obj.def("addLinkEqualCon",
                py::overload_cast<VectorFunctionalX, RegVec,
        ...
        obj.def("addForwardLinkEqualCon",
                py::overload_cast<PhasePtr, PhasePtr, VectorXi>(
                    &OptimalControlProblem::addForwardLinkEqualCon),
                OptimalControlProblem_addForwardLinkEqualCon);
        ...
        obj.def("addDirectLinkEqualCon",
                py::overload_cast<VectorFunctionalX, int, PhaseRegionFlags, VectorXi, int,
                                  PhaseRegionFlags, VectorXi>(
                    &OptimalControlProblem::addDirectLinkEqualCon),
                OptimalControlProblem_addDirectLinkEqualCon);

        obj.def("addDirectLinkEqualCon",
                py::overload_cast<VectorFunctionalX, PhasePtr, PhaseRegionFlags, VectorXi, PhasePtr,
                                  PhaseRegionFlags, VectorXi>(
                    &OptimalControlProblem::addDirectLinkEqualCon),
                OptimalControlProblem_addDirectLinkEqualCon);
        ...
        //
        obj.def("addDirectLinkEqualCon",
                py::overload_cast<VectorFunctionalX, int, std::string, VectorXi, int, std::string,
                                  VectorXi>(&OptimalControlProblem::addDirectLinkEqualCon),
                OptimalControlProblem_addDirectLinkEqualCon);

        obj.def(
            "addDirectLinkEqualCon",
            py::overload_cast<VectorFunctionalX, PhasePtr, std::string, VectorXi, PhasePtr,
...

    {
        ...
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, std::vector<std::string>, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkObjective));

        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, LinkFlags, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkObjective));
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, std::string, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkObjective));
        ...
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, std::vector<std::string>,
                              std::vector<std::vector<PhasePtr>>, std::vector<VectorXi>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>>(
                &OptimalControlProblem::addLinkObjective));
        ...
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, LinkFlags, std::vector<std::vector<PhasePtr>>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkObjective));
        obj.def(
            "addLinkObjective",
            py::overload_cast<ScalarFunctionalX, std::string, std::vector<std::vector<PhasePtr>>,
                              std::vector<VectorXi>, std::vector<VectorXi>, std::vector<VectorXi>,
                              std::vector<VectorXi>>(&OptimalControlProblem::addLinkObjective));
