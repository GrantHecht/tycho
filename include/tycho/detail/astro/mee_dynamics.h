...
struct MEEDynamics : VectorFunction<MEEDynamics, 9, 6, DenseDerivativeMode::Analytic,
    ...
    inline void compute_impl(CVecRef<InType> x_, CVecRef<OutType> fx_) const {
        ...
        _fx_[3] = x10 * x22;
        _fx_[4] = x11 * x22;
        _fx_[5] = x20 * (mu_ * x13 * x13 / (x0 * x0) + 1.0 * x21);
    }
    ...
    inline void compute_jacobian_impl(CVecRef<InType> x_,
        ...
        _jx_(5, 4) = -x38 * x82;
        _jx_(0, 5) = x50 * x53;
        _jx_(1, 5) = x31 * (x16 * (-x35 + x64 * x9) + x2 * x24 * (-x62 - x63) + x2 * x53 * x58 +
                            x32 + x53 * x59);
    ...
    inline void compute_jacobian_adjointgradient_adjointhessian_impl(
        ...
        _hx_(3, 0) = x239;
        _hx_(4, 0) = x241;
        _hx_(5, 0) = LM3 * (-x163 + x226 * x63) + LM4 * (x141 * x169 + x142) - LM5 * x242 +
                     LM5 * x243 + x244;
        _hx_(6, 0) = x245;
        _hx_(7, 0) = x247;
        _hx_(8, 0) = x249;
        ...
        _hx_(8, 4) = x359;
        _hx_(0, 5) =
            -LM3 * x163 + LM4 * x142 + LM5 * (-x242 + x243) + x169 * x231 + x232 * x63 + x244;
        _hx_(1, 5) = -LM3 * x145 * x257 * x299 - LM4 * x146 - LM4 * x305 + x149 * x253 + x197 +
                     x198 + x199 * (-x10 * x314 - x282 * x300 + x316 + x318) +
                     x200 * (-x277 * x300 - x310 * x78 + x313) +
                     x207 * (-x300 * x307 + x306 * x50 + x309) - x300 * x303;
        ...
        _hx_(3, 5) = -LM3 * x166 + LM4 * x154 + LM4 * x349 + x199 * x346 - x200 * x347 + x202 -
                     x203 + x204 + x207 * x345 + x236 * x348;
        _hx_(4, 5) = -LM3 * x167 + LM4 * x155 + LM4 * x358 - x199 * x357 + x200 * x356 + x201 +
                     x240 * x348 - x289 * x355;
        _hx_(5, 5) = LM3 * (x158 * x371 * x8 + x158 * x372 - x33 * x345 * x43 - x46) +
                     LM4 * (x156 + x270 * x355 + x304 * x372 + x340 * x364) +
                     x199 * (x1 * x27 + 2 * x1 * x373 + x1 * x374 + x132 * x375 +
                             x16 * (x100 + x11 * x376 + x306) + x266 * x369 + x282 * x370 +
                             x327 * x370 + x34) +
                     x200 * (x101 * x375 + 2 * x157 * x377 +
                             x16 * (-x131 + x168 + x376 * x9 + x9 * (x376 - 2.0)) + x2 * x37 - x22 +
                             x261 * x369 + x261 * x371 + x262 * x369 + x277 * x370) +
                     x207 * (x14 * x50 * (-x274 - x280) + x192 * x98 + 1.0 * x27 + x314 * x362 +
                             2.0 * x373 + 1.0 * x374) +
                     x302 * x369 + x302 * x371;
        _hx_(6, 5) = x378;
        _hx_(7, 5) = x102 * x200 + x130 * x199 + x133 * x199 + x200 * x97 + x379;
        _hx_(8, 5) = -LM3 * x172 + LM3 * x388 + LM4 * x161 + LM4 * x389 + x199 * x381 +
                     x199 * x383 + x200 * x386 + x200 * x387 + x207 * x384 + x207 * x385;
        _hx_(0, 6) = x245;
        _hx_(1, 6) = 0;
        _hx_(2, 6) = 0;
        _hx_(3, 6) = 0;
