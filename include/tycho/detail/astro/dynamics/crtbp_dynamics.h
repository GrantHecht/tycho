...
///
/// State and control input: [x, y, z, vx, vy, vz, ax_ctrl, ay_ctrl, az_ctrl] in rotating
/// (synodic) coordinates. mu is the mass ratio of the smaller primary: mu = m2/(m1+m2) ∈ (0,1).
/// Output (state derivative): [vx, vy, vz, ẍ, ÿ, z̈] in the synodic frame.
