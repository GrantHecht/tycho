...
struct FunctionVectorProduct_Impl
    ...
    inline void compute_jacobian_impl(ConstVectorBaseRef<InType> x, ConstVectorBaseRef<OutType> fx_,
        ...
        if constexpr (IsSegmentOp) {
            ...
            this->func2.compute(x, fx2);
            fx = this->vecprodimpl(Scalar(1.0), fx1, fx2);
            this->fillprodmatrix(fx2, jx.template middleCols<Vsize>(this->func1.SegStart, Vsize),
                                 fsign1);
            this->fillprodmatrix(fx1, jx.template middleCols<Vsize>(this->func2.SegStart, Vsize),
                                 fsign2);
        } else {
            ...
            auto Impl = [&](auto &jx1, auto &jx2) {
                ...
                this->func1.right_jacobian_product(jx, pm1, jx1, DirectAssignment(),
            ...
            BumpAllocator::allocate_run(Impl, TempSpec<JType>(Vsize, irows),
    ...
    inline void compute_jacobian_adjointgradient_adjointhessian_impl(
        ...
        auto Impl = [&](auto &jx1, auto &jx2, auto &jttemp, auto &gx2, auto &hx2) {
            ...
            this->func2.right_jacobian_product(jttemp, lpm2, jx2, DirectAssignment(),
                                               std::bool_constant<false>());
